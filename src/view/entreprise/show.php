...
<div class="container">
    <form class="row g-3" action="" method="post">
        <div class="col-md-6">
            <label for="nomEntreprise" class="form-label" ><?=$entreprise["nom_entreprise"]?></label>

        </div>
        <div class="col-md-6">
            <label for="text" class="form-label">NomRepondant</label>
            <label for="nomr" class="form-control" id="nomR" name="nom_repondant" value="<?=$entreprise['nom_repondant']?>">
        </div>
        <div class="col-12">
            <label for="email" class="form-label">EmailRepondant</label>
            <input type="email" class="form-control" id="email" name="email_repondant" value="<?=$entreprise['email_repondant']?>">
        </div>
        <div class="col-12">
            <label for="inputAddress2" class="form-label">NumeroRepondant</label>
            <input type="number" class="form-control" id="inputAddress2" name="numero_repondant" value="<?=$entreprise['numero_repondant']?>">
        </div>
        <div class="col-md-6">
            <label for="inputCity" class="form-label">SiegeSocial</label>
            <input type="text" class="form-control" id="inputCity"  name="siege_social" value="<?=$entreprise['siege_social']?>">
        </div>
        <div class="col-md-6">
            <label for="inputCity" class="form-label">DateCreation</label>
            <input type="date" class="form-control" id="inputCity" name="date_creation" value="<?=$entreprise['date_creation']?>">
        </div>
        <div class="col-md-6">
            <label for="inputCity" class="form-label">RegistreCommerce</label>
            <input type="text" class="form-control" id="inputCity" name="registre_commerce" value="<?=$entreprise['registre_commerce']?>">
        </div>

        <div class="col-md-6">
            <label for="inputCity" class="form-label">Domaine</label>
            <input type="text" class="form-control" id="inputCity" name="domaine" value="<?=$entreprise['domaine']?>">
        </div>
        <div class="col-md-6">
            <label for="inputCity" class="form-label">PageWeb</label>
            <input type="text" class="form-control" id="inputCity" name="page_web" value="<?=$entreprise['page_web']?>">
        </div>
        <div class="col-md-6">
            <label for="inputCity" class="form-label">Contrat</label>
            <select id="inputState" class="form-select" name="contrat">
                <option selected>contrat</option>
                <option> oui</option>
                <option> Non</option>
            </select>
<!--            <input type="text" class="form-control" id="inputCity" name="contrat" value="--><?//=$entreprise['contrat']?><!--">-->
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="inputCity" name="ninea" value="<?=$entreprise['ninea']?>">
        </div>

        <div class="col-md-6">
            <label for="inputCity" class="form-label">Cotisation</label>
            <input type="text" class="form-control" id="inputCity" name="cotisations" value="<?=$entreprise['cotisations']?>">
        </div>
        ...
        <div>
            <button type="submit" class="btn btn-primary" name="modifier">Modificatier</button>
        </div>
    </form>
